public interface DataBase {
    ...
    //Se agrego esta interfaz por el principio de Dependency Inversion, ya que en el AppWeb
    //dependia concretamente de MySql, pero si en el futuro se desea agregar bases de datos relacionales
